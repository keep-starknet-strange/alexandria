...
fn test_reverse_bytes_u512() {
    ...
    let t_rev = u512{limb0: t3.reverse_bytes(), limb1: t2.reverse_bytes(), limb2: t1.reverse_bytes(), limb3: t0.reverse_bytes()};
    let rev = t.reverse_bytes();
...
fn test_reverse_bytes_bytes31() {
    ...
    let t_rev_u256 = u256 {
        low: 0x2e2d2c2b2a292827262524232221201f,
        high: 0x1e1d1c1b1a19181716151413121110,
    };
...
fn test_reverse_bits_u256() {
    ...
    let t_rev: u256 = u256 {
        low: 0xeeeeeeeeeeeeeeee3333333333333333,
        high: 0x55555555555555558888888888888888,
    };
    let rev = t.reverse_bits();
    assert(rev == t_rev, 'not equal rev');
    assert(rev.reverse_bits() == t, 'not equal');
...
fn test_reverse_bits_bytes31() {
    ...
    let t_rev_u256: u256 = u256 {
        low: 0xedcb754321edcb754321edcb75432148,
        high: 0x7b3dea2c487b3dea2c487b3dea2c48,
    };
    let t_rev_felt: felt252 = t_rev_u256.try_into().unwrap();
    let t_rev: bytes31 = t_rev_felt.try_into().unwrap();
    let rev = t.reverse_bits();
