...
impl MerkleTreeImpl of MerkleTreeTrait {
    ...
    /// The merkle root.
    fn compute_root(
        ref self: MerkleTree, current_node: felt, mut proof: Array::<felt>
        ...
        //internal_compute_root(ref self, current_node, 0_u128, proof_len, proof)
        0
    }
}
...
fn internal_compute_root(
    ...
    internal_compute_root(ref self, node, proof_index + 1_u128, proof_len - 1, proof)
}
