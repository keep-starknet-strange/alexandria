use alexandria_storage::proof::{
    ContractStateProof, ContractData, TrieNode,
    BinaryNode, EdgeNode, verify
};
...
fn proof1_test() {
    ...
    let expected_value = 3297450976341993905338014621774626109218148093827950687289193790013996697606;
