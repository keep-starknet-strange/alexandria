...
//         let empty_list = ListTrait::<u128>::fetch(0, storage_address).expect('List fetch
//         failed');
...
//         let numbers_address = contract_state.numbers.address();
//         let numbers_list = ListTrait::<u256>::fetch(0, numbers_address).expect('List fetch
//         failed');
//         assert_eq!(numbers_list.address_domain, 0, "Address domain should be 0");
...
//         assert_eq!((array_addr.len(), array_number.len()), contract.do_get_len(), "lens
//         mismatch");
