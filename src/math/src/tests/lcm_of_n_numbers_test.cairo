...
fn lcm_test() {
    ...
    assert_eq!(lcm(arr.span()).unwrap(), 120, "invalid result");
}
...
fn lcm_test_3() {
    ...
    assert_eq!(lcm(arr.span()).unwrap(), 396, "invalid result");
}
...
fn lcm_test_4() {
    ...
    assert_eq!(lcm(arr.span()).unwrap(), 24, "invalid result");
}
...
fn lcm_single_test() {
    ...
    assert_eq!(lcm(arr.span()).unwrap(), 10, "invalid result");
}
