...
fn value_found() {
    ...
    assert!(binary_search(span, 100).unwrap() == 0);
    assert!(binary_search(span, 200).unwrap() == 1);
    assert!(binary_search(span, 300).unwrap() == 2);
    assert!(binary_search(span, 400).unwrap() == 3);
    assert!(binary_search(span, 500).unwrap() == 4);
    assert!(binary_search(span, 600).unwrap() == 5);
    ...
    assert!(binary_search(span, 500).unwrap() == 4);
    assert!(binary_search(span, 600).unwrap() == 5);
    assert!(binary_search(span, 700).unwrap() == 6);
}
