...
fn add_edge() {
    ...
    assert_eq!(span.len(), 2, "wrong nb of adj edge for node 2");
}
...
fn calculate_shortest_path() {
    ...
    assert_eq!(results.get(0.into()), 0, "Wrong weight for node 0");
    assert_eq!(results.get(1.into()), 5, "Wrong weight for node 1");
    assert_eq!(results.get(2.into()), 3, "Wrong weight for node 2");
    assert_eq!(results.get(3.into()), 2, "Wrong weight for node 3");
    assert_eq!(results.get(4.into()), 3, "Wrong weight for node 4");
    assert_eq!(results.get(5.into()), 3, "Wrong weight for node 5");
}
...
fn calculate_shortest_path_random() {
    ...
    assert_eq!(results.get(0.into()), 0, "Wrong weight for node 0");
    assert_eq!(results.get(2.into()), 4, "Wrong weight for node 2");
    assert_eq!(results.get(3.into()), 5, "Wrong weight for node 3");
    assert_eq!(results.get(1.into()), 8, "Wrong weight for node 1");
    assert_eq!(results.get(4.into()), 7, "Wrong weight for node 4");
}
