...
fn u256_to_ascii() {
    ...
    assert!(ascii.len() == 3);
    assert!(*ascii.at(0) == '1157920892373161954235709850086');
    assert!(*ascii.at(1) == '8790785326998466564056403945758');
    assert!(*ascii.at(2) == '4007913129639935');
    // ------------------------------ min u256 test ----------------------------- //
...
fn u128_to_ascii() {
    ...
    assert!(ascii.len() == 2);
    assert!(*ascii.at(0) == '3402823669209384634633746074317');
    assert!(*ascii.at(1) == '68211455');
    // ------------------------------ min u128 test ----------------------------- //
...
fn u64_to_ascii() {
    ...
    assert!(num.to_ascii() == '18446744073709551615');
    // ------------------------------ min u64 test ------------------------------ //
    let num: u64 = Bounded::MIN;
    assert!(num.to_ascii() == '0');
}
...
fn u32_to_ascii() {
    ...
    assert!(num.to_ascii() == '4294967295');
    // ------------------------------ min u32 test ------------------------------ //
