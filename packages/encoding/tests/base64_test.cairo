...
fn base64_round_trip_test() {
    ...
    assert!(decoded1.len() == input1.len(), "Round trip length mismatch for Test");
    assert!(*decoded1[0] == 'T');
    assert!(*decoded1[1] == 'e');
    assert!(*decoded1[2] == 's');
    assert!(*decoded1[3] == 't');
    ...
    assert!(decoded2.len() == input2.len(), "Round trip length mismatch for Test1");
    assert!(*decoded2[0] == 'T');
    assert!(*decoded2[1] == 'e');
    assert!(*decoded2[2] == 's');
    assert!(*decoded2[3] == 't');
    ...
    assert!(decoded3.len() == input3.len(), "Round trip length mismatch for Test12");
    assert!(*decoded3[0] == 'T');
    assert!(*decoded3[1] == 'e');
    assert!(*decoded3[2] == 's');
    assert!(*decoded3[3] == 't');
    ...
    assert!(decoded4.len() == input4.len(), "Round trip length mismatch for Test123");
    assert!(*decoded4[0] == 'T');
    assert!(*decoded4[1] == 'e');
    assert!(*decoded4[2] == 's');
    assert!(*decoded4[3] == 't');
...
fn base64_binary_data_test() {
    ...
    assert!(*decoded[0] == 0);
    assert!(*decoded[1] == 127);
    assert!(*decoded[2] == 128);
...
fn base64url_round_trip_test() {
    ...
    assert!(*decoded[1] == 239);
    assert!(*decoded[2] == 223);
    assert!(*decoded[3] == 191);
}
