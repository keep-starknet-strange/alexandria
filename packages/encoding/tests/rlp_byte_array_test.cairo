...
fn test_ba_rlp_encode_string_length_exactly_56() {
    ...
    assert!(
        result == 0xB838606060606060606060606060606060606060606060606060606060606060,
        "encoding assertion failed",
    );
    let (_, result) = res.read_uint_within_size(new_offset, 26);
    assert!(result == 0x6060606060606060606060606060606060606060606060606060);
}
...
fn test_ba_rlp_encode_string_length_greater_than_56() {
    ...
    assert!(
        result == 0xB83C707070707070707070707070707070707070707070707070707070707070,
        "encoding assertion failed",
    );
    let (_, result) = res.read_uint_within_size(new_offset, 30);
    assert!(
        result == 0x707070707070707070707070707070707070707070707070707070707070,
        "encoding assertion failed",
    );
}
...
fn test_ba_rlp_encode_short_list() {
    ...
    assert!(data == 0xc9833535354283453892);
}
