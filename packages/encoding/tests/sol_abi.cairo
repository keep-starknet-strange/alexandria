...
fn encode_test() {
    let expected: Bytes = BytesTrait::new(
        544,
        array![
            0x00000000000000000000000000000000, 0x0000000000000000000000000000001a,
            0x00000000000000000000000000000000, 0x101112131415161718191a1b1c1d1e1f,
            0x00000000000000000000000000000000, 0x000000000000000000000000ddccbbaa,
            0x00000000000000000000000000000000, 0x00000000000000000000000000001112,
            0x00000000000000000000000000000000, 0x0000000000000000090a0b0c0d0e0f10,
            0x00000000000000000000000000000000, 0x00000000000000000000000000000001,
            0x0102030405060708090a0b0c0d0e1011, 0x12131415161718191a1b1c1d1e1f2021,
            0x00000000000000000000000000000000, 0x00000000000000000000000000000000,
            0x00000000000000000000000000000000, 0x00000000000000000000000000000001,
            0x00000000000000000000000000000000, 1234567890, 0x0000000000000000000000000000abcd,
            0xefabcdefabcdefabcdefabcdefabcdef, 0x000a0b0c0d0e0f000000000000000000,
            0x00000000000000000000000000000000, 0x0000abcdef0000000000000000000000,
            0x00000000000000000000000000000000, 0x049d36570d4e46f48e99674bd3fcc846,
            0x44ddd6b96f7c741b1562b82f9e004dc7, 0x000000000000000000000000DeaDbeef,
            0xdEAdbeefdEadbEEFdeadbeEFdEaDbeeF, 0xc0ffeec0ffeec0ffeec0ffeec0ffeec0,
            0xffeec0ffeec0ffeec0ffeec0ffeec0ff, 0xc0ffeec0ffeec0ffeec0ffeec0ffeec0,
    ...
    let arbitrary_data: ByteArray = BytesTrait::new(
        64,
        array![
            0xc0ffeec0ffeec0ffeec0ffeec0ffeec0, 0xffeec0ffeec0ffeec0ffeec0ffeec0ff,
            0xc0ffeec0ffeec0ffeec0ffeec0ffeec0, 0xffeec0ffeec0ffeec0ffeec0ffeec0ff,
        ],
    )
        .into();
...
fn encode_packed_test() {
    let expected: Bytes = BytesTrait::new(
        195,
        array![
            0x0800000000000000a7a8a9aaabacadae, 0xaf000abcde002a00000000101112130f,
            0xa0a1a2a3a4a5a6a7a8a9aaabacadaeaf, 0xb0b1b2b3b4b5b6b7b8b9babbbcbdbe00,
            0x01000000000000000000000000000000, 0x00000000000000000000000000001234,
            0x0102030405060708090a000000000000, 0x00000000000000000000000000000000,
            0x00000000001234567890049d36570d4e, 0x46f48e99674bd3fcc84644ddd6b96f7c,
            0x741b1562b82f9e004dc7DeaDbeefdEAd, 0xbeefdEadbEEFdeadbeEFdEaDbeeFa0aa,
...
fn selector_test() {
    ...
    let expected: Bytes = BytesTrait::new(
        68,
        array![
            0xa9059cbb000000000000000000000000, 0xDeaDbeefdEAdbeefdEadbEEFdeadbeEF,
            0xdEaDbeeF000000000000000000000000, 0x00000000000000000000000000000000,
...
fn sol_bytes_test() {
    ...
    assert!(expectedVal14 == bytesValAcc);
    ...
    assert!(expectedVal21 == bytesValAcc);
    ...
    assert!(expectedVal25 == bytesValAcc);
}
