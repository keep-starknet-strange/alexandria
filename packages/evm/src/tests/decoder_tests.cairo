...
fn test_decode_bytes32_zeroes() {
    ...
    assert_eq!(*decoded.at(0), 1);
    assert_eq!(*decoded.at(1), 0x00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffff);
...
fn test_decode_bytes32() {
    ...
    assert_eq!(*decoded.at(0), 1);
    assert_eq!(*decoded.at(1), 0xaaffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff);
    assert_eq!(*decoded.at(2), 0xff);
    assert_eq!(*decoded.at(3), 1);
}
...
fn test_decode_bytes2() {
    ...
    assert_eq!(*decoded.at(0), 1);
    assert_eq!(*decoded.at(1), 0xff);
    assert_eq!(*decoded.at(2), 0x22);
    assert_eq!(*decoded.at(3), 1);
}
...
fn test_decode_bytes31() {
    ...
    assert_eq!(*decoded.at(0), 1);
    assert_eq!(*decoded.at(1), 0xff2200000000000000000000000000000000000000000000000000000000);
...
fn test_decode_address() {
    ...
    assert_eq!(*decoded.at(0), 0x742d35Cc6634C0532925a3b844Bc454e4438f44e);
}
...
fn test_decode_transfer_from() {
    ...
    data.append_u32(0x23b872dd); // keccak256("transferFrom(address,address,uint256)")
    ...
    assert_eq!(*decoded.at(0), selector.into());
    assert_eq!(*decoded.at(1), expected_from.into());
    assert_eq!(*decoded.at(2), expected_to.into());
    assert_eq!(*decoded.at(3), expected_amount.into());
}
