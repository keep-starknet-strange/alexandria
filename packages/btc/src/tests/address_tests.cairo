...
fn test_invalid_address_length() {
    ...
    // Too long address
    assert!(!validate_address("1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa1234567890123456789", BitcoinNetwork::Mainnet));
...
fn test_invalid_address_characters() {
    ...
    assert!(validate_address("bc1qw508d6qejxtdg4y5r3zarvary0c5xw7kv8f3t4XYZ", BitcoinNetwork::Mainnet));
}
...
fn test_wrong_network_prefix() {
    ...
    assert!(!validate_address("tb1qw508d6qejxtdg4y5r3zarvary0c5xw7kxpjzsx", BitcoinNetwork::Mainnet));
}
...
fn test_invalid_address_prefix() {
    ...
    assert!(!validate_address("tc1qw508d6qejxtdg4y5r3zarvary0c5xw7kv8f3t4", BitcoinNetwork::Mainnet));
}
...
fn test_malformed_addresses() {
    ...
    // Note: Current implementation only validates basic format
    assert!(validate_address("bc qw508d6qejxtdg4y5r3zarvary0c5xw7kv8f3t4", BitcoinNetwork::Mainnet));
...
fn test_address_length_boundaries() {
    ...
    let max_length_addr = "bc1qw508d6qejxtdg4y5r3zarvary0c5xw7kv8f3t4111111111111111111111111111111111111111111111111111111111111";
    assert!(!validate_address(max_length_addr, BitcoinNetwork::Mainnet)); // 63+ chars
    
    // Test valid length
    assert!(validate_address("1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa", BitcoinNetwork::Mainnet)); // 34 chars
}
