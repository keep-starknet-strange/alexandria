...
fn ripemd160_standard_test_string_a() {
    ...
    assert_eq!(hash, expected_hash, "Standard test string 'a' failed");
}
...
fn ripemd160_standard_test_string_abc() {
    ...
    assert_eq!(hash, expected_hash, "Standard test string 'abc' failed");
}
...
fn ripemd160_standard_test_string_message_digest() {
    ...
    assert_eq!(hash, expected_hash, "Standard test string 'message digest' failed");
}
...
fn ripemd160_standard_test_string_alphabet() {
    ...
    assert_eq!(hash, expected_hash, "Standard test string alphabet failed");
}
...
fn ripemd160_standard_test_string_alphanumeric() {
    ...
    assert_eq!(hash, expected_hash, "Standard test string alphanumeric failed");
}
...
fn ripemd160_standard_test_string_digits_repeated() {
    ...
    assert_eq!(hash, expected_hash, "Standard test string repeated digits failed");
}
...
fn ripemd160_test_context_as_bytes() {
    ...
    assert_eq!(hash_bytes.len(), 20, "RIPEMD-160 should produce 20 bytes");
}
...
fn ripemd160_test_context_as_array() {
    ...
    assert_eq!(hash_array.len(), 5, "RIPEMD-160 should produce 5 u32 values");
}
...
fn ripemd160_test_context_conversions_consistency() {
    ...
    assert_eq!(hash_bytes.len(), 20, "Bytes length should be 20");
    assert_eq!(hash_array.len(), 5, "Array length should be 5");
