...
fn interp_constant_left_diff() {
    ...
    assert!(@interpolate(0, xs, ys, inter, extra) == @0);
    assert!(@interpolate(1, xs, ys, inter, extra) == @2);
    assert!(@interpolate(2, xs, ys, inter, extra) == @2);
    assert!(@interpolate(3, xs, ys, inter, extra) == @4);
    assert!(@interpolate(4, xs, ys, inter, extra) == @4);
    assert!(@interpolate(5, xs, ys, inter, extra) == @6);
    assert!(@interpolate(6, xs, ys, inter, extra) == @6);
    assert!(@interpolate(7, xs, ys, inter, extra) == @8);
    assert!(@interpolate(8, xs, ys, inter, extra) == @8);
    assert!(@interpolate(9, xs, ys, inter, extra) == @8);
}
