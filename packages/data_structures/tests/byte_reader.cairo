...
fn test_read_sequence() {
    ...
    assert!(
        rd.read_i128() == Option::Some(0x02030405060708090a0b0c0d0e0f1011), "values should match",
    );
    assert!(
        rd.read_u128() == Option::Some(0x12131415161718191a1b1c1d1e1f2021), "values should match",
    );
    assert!(rd.read_i64() == Option::Some(0x2223242526272829));
    assert!(
        rd.read_u128() == Option::Some(0x2a2b2c2d2e2f30313233343536373839), "values should match",
    );
