...
fn extended_euclidean_algorithm_test() {
    ...
    test_case(101, 13, (1, 4, 0-31));
    test_case(123, 19, (1, 0-2, 13));
    test_case(25, 36, (1, 13, 0-9));
    test_case(69, 54, (3, 0-7, 9));
    test_case(55, 79, (1, 23, 0-16));
    test_case(33, 44, (11, 0-1, 1));
    test_case(50, 70, (10, 3, 0-2));
}
